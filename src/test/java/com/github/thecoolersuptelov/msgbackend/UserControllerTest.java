...
public class UserControllerTest {
    ...
    public void should_ReturnBadRequest_Then_DuplicateUsernameCreation() throws Exception {
        ...
        var doubleResponseUserCreation = mockMvc.perform(post("/users/add").content("{\"username\": \"user_" + currentTimeMillis + "\"}").contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse();
